...
@Service
public class AuthSellerService implements AuthService {
    ...
    public AuthSellerService(UserRepository userRepository, PasswordEncoder passwordEncoder, UnifiedNotificationDispatcher unifiedNotificationDispatcher, AuthLoginService authLoginService) {
