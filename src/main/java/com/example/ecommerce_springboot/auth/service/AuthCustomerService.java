...
@Service
public class AuthCustomerService implements AuthService {
    ...
    public AuthCustomerService(UserRepository userRepository, PasswordEncoder passwordEncoder, UnifiedNotificationDispatcher unifiedNotificationDispatcher, AuthLoginService authLoginService) {
