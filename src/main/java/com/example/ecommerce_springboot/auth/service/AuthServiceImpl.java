...
//
//    @Transactional
//    public UserSignupResponseDTO signUpCustomer(String name, String username, String email, String password,UserRole userRole) throws UserAlreadyExistException {
...
//        }
//        if (userRepository.existsByEmailAndIsDeltedFalse(email)) {
